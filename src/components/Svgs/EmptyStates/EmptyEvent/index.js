...
const EmptyEventIcon = ({ width, height, size, color }) => {
  return (
    <Svg
      ...
      <Path
        opacity={0.4}
        d="M21 10.84v1.74c0 .61-.54 1.08-1.14.98-.28-.04-.57-.07-.86-.07a5.51 5.51 0 00-5.5 5.5c0 .46.18 1.1.37 1.68a.998.998 0 01-.95 1.32H8c-3.5 0-5-2-5-5v-6.16c0-.55.45-1 1-1h16c.55.01 1 .46 1 1.01z"
        fill={Colors.purple['500']}
      />
      <Path
